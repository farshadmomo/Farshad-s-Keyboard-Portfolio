...
export function MobileContact() {
  return (
    <div id="mcontact" className="flex min-h-[100svh] flex-col gap-8 px-6 pb-24 pt-10">
      ...
      <p className="mt-2 font-mono text-[10px] uppercase tracking-[0.15em] text-fg-dim">
...
export function MobileWork() {
  return (
    <div id="mwork" className="flex min-h-[100svh] flex-col gap-8 px-6 pb-24 pt-10">
      ...
      <div className="flex flex-col gap-4">
        {PROJECTS.map((p) => (
          <a
            key={p.n}
            href="#mwork"
            className="pointer-events-auto flex flex-col gap-2 border border-border bg-bg-elev/70 p-4 backdrop-blur-sm"
          >
